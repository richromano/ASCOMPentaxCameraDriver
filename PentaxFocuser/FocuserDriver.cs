...
//
// ASCOM Focuser driver for PentaxKPFocuser
//
...
namespace ASCOM.PentaxKPCameraFocuser
{
    //
    // Your driver's DeviceID is ASCOM.PentaxKPCameraFocuser.Focuser
    //
    // The Guid attribute sets the CLSID for ASCOM.PentaxKPCameraFocuser.Focuser
    ...
    public class Focuser : IFocuserV3
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.PentaxKPCameraFocuser.Focuser";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Focuser Driver for PentaxKPCameraFocuser.";
        ...
        public Focuser()
        {
            tl = new TraceLogger("", "PentaxKPCameraFocuser");
        ...
        public void SetupDialog()
        {
            ...
            if (IsConnected)
                System.Windows.Forms.MessageBox.Show("Pentax Already connected, just press OK");
